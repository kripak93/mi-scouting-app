...
This is the main entry point. Scouts land directly on the form.
Dashboard is a separate page (password-protected).
"""
...
# Hide sidebar and page navigation completely
st.markdown("""
<style>
